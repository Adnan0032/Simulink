...
#ifndef RTW_HEADER_stateflowLED_types_h_
#define RTW_HEADER_stateflowLED_types_h_
#include "rtwtypes.h"
...
typedef struct tag_RTM_stateflowLED_T RT_MODEL_stateflowLED_T;

#endif                                 /* RTW_HEADER_stateflowLED_types_h_ */
