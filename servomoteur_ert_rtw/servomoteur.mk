###########################################################################
## Makefile generated for Simulink model 'servomoteur'. 
## 
## Makefile     : servomoteur.mk
## Generated on : Tue Nov 07 08:59:50 2023
## MATLAB Coder version: 5.0 (R2020a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/servomoteur.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/servomoteur.elf
...
DEFINES_ = -DMODEL=servomoteur -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -DTERMFCN=1 -DONESTEPFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=1 -DXCP_CUSTOM_PLATFORM -DEXIT_FAILURE=1 -DEXTMODE_DISABLEPRINTF -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DSTACK_SIZE=64 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DRT -DMW_TIMERID=2 -DMW_PRESCALAR=256 -DMW_TIMERCOUNT=131 -DMW_SCHEDULERCOUNTER=5 -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_ANALOG_REF_=0 -D_RTT_NUMSERVOS_=1
...
DEFINES_STANDARD = -DMODEL=servomoteur -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_ServoWriteRead.o MW_arduino_digitalio.o servomoteur.o servomoteur_data.o MW_ArduinoHWInit.o io_wrappers.o MW_PWMDriver.o arduinoAVRScheduler.o
...
%.o : $(START_DIR)/servomoteur_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/servomoteur_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/servomoteur_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/servomoteur_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


servomoteur.o : $(START_DIR)/servomoteur_ert_rtw/servomoteur.c
	$(CC) $(CFLAGS) -o "$@" "$<"


servomoteur_data.o : $(START_DIR)/servomoteur_ert_rtw/servomoteur_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
